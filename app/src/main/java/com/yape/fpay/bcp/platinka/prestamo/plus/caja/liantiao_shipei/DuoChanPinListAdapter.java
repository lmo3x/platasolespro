 ...
 * 设备列表页面
 */
public class DuoChanPinListAdapter extends BaseQuickAdapter<DuoproChapinModel.RoughNaturalProDTO, BaseViewHolder> {

    private Context context;

    public DuoChanPinListAdapter(Context context, List<DuoproChapinModel.RoughNaturalProDTO> data) {
    ...
    protected void convert(BaseViewHolder helper, DuoproChapinModel.RoughNaturalProDTO redChairDTO) {
        ...
        helper.setTextColor(R.id.duoChanPinItemBtn2, context.getResources().getColor(R.color.sezhi_argb_baise));
        helper.setBackgroundRes(R.id.glrewrewtyeyer, R.drawable.dengdai_miaoshu_bg);
        switch (type) {
            case "0":
                if (redChairDTO.getCurrentIndex() < 3) {
                    helper.setGone(R.id.itemType01Rl, true);
                    helper.setGone(R.id.itemType02Rl, false);
                    Glide.with(context)
                            .load(redChairDTO.getExcellentLawyerExamFierceCellar())
...
//                            helper.setTextColor(R.id.rankingTv, context.getResources().getColor(R.color.sezhi_argb_A80000));
                    ...
                    helper.setGone(R.id.sadjoigjfasa, false);
                    helper.setGone(R.id.weixiadanmore3, true);
                    Glide.with(context)
                            .load(redChairDTO.getExcellentLawyerExamFierceCellar())
                            .error(R.mipmap.useimg_desklogo)
                            .apply(RequestOptions.circleCropTransform())
                    ...
                    helper.setTextColor(R.id.duoChanPinItemStateTv, context.getResources().getColor(R.color.sezhi_argb_A80000));
                    helper.setBackgroundRes(R.id.duoChanPinItemRectangleView, R.drawable.lylt_baishfif);

                    helper.setBackgroundRes(R.id.duoChanPinItemBtn2, R.drawable.bj_userallow_yes);
                    helper.setText(R.id.duoChanPinItemBtn2, context.getResources().getString(R.string.zhuyetab_tudai_des_apl));
                    helper.setBackgroundRes(R.id.glrewrewtyeyer, R.drawable.dengdai_miaoshuwe_bg);
                }
                break;
            ...
            case "1"://已放款(待还款)
                ...
                helper.setGone(R.id.itemType01Rl, false);
                helper.setGone(R.id.itemType02Rl, true);
                helper.setGone(R.id.sadjoigjfasa, true);
                helper.setGone(R.id.weixiadanmore3, false);
                //tu biao
                Glide.with(context)
                        .load(redChairDTO.getExcellentLawyerExamFierceCellar())
                        .error(R.mipmap.useimg_desklogo)
                ...
                helper.setBackgroundRes(R.id.duoChanPinItemBtn2, R.drawable.bj_userallow_yes);
                //anniu wenan
                helper.setText(R.id.duoChanPinItemBtn2, context.getResources().getString(R.string.zhuyetab_ryingzhong_lty));
                break;
            ...
            case "6"://放款中
                ...
                //anniu wenan
                helper.setText(R.id.duoChanPinItemBtn2, context.getResources().getString(R.string.zhuyetab_doingwork_shenhe));
                helper.setTextColor(R.id.duoChanPinItemBtn2, context.getResources().getColor(R.color.sezhi_argb_999999));
                break;
